...
def build_quote_pdf(quote_data: dict[str, Any], logo_file: bytes | None = None) -> BytesIO:
    ...
    story.append(_paragraph("Este orçamento apresenta valores por faixa de quantidade total do pedido. No pedido, a métrica será definida pela soma das quantidades de todos os itens selecionados.", styles["Small"]))
